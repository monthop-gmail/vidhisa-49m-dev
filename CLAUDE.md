...
| PLJ-Bxxx                 | สถาบันพลังจิตตานุภาพ — auto-create 1 org ต่อ 1 สาขา (PLJ-B001, PLJ-B002, ...) |
...
- ยอดรวม = สถาบันฯ (PLJ-Bxxx) + องค์กรภายนอก
- รายสาขา/กลุ่มสาขา = เฉพาะ `org_id LIKE 'PLJ-%'`
...
- 126 test cases ครอบคลุมทุก endpoint
